...
var ConversationPanel = (function () {
    ...
    function chatUpdateSetup() {
        ...
        //Added by me... not sure if it works.  
        /*var currentScoreResponsePayloadSetter = Api.setScoreResponsePayload;
        Api.setScoreResponsePayload = function (newPayloadStr) {
            currentScoreResponsePayloadSetter.call(Api, newPayloadStr);
            displayMessage(JSON.parse(newPayloadStr), settings.authorTypes.watson);
        };*/
    }
    ...
    function displayMessage(newPayload, typeValue) {
        ...
        var textExists = (newPayload.input && newPayload.input != '/new') || (newPayload.convo && newPayload.convo.output && newPayload.convo.output.text);
    ...
    function buildMessageDomElements(newPayload, isUser) {
        ...
        var textArray = isUser ? newPayload.input : newPayload.convo.output.text;
